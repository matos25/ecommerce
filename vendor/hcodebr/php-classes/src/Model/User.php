<?php 
		...
		public static function getForgot($email)
		{
			...
			else
			{
				...
				if ($inadmin === true) {
					...
					$link = "http://www.supermercadoslim.com.br/admin/forgot/reset?code=$code";

				} else {

					$link = "http://www.supermercadoslim.com.br/forgot/reset?code=$code";
	...
	public static function validForgotDecrypt($code)
	{
		...
		$idrecovery = openssl_decrypt($dataRecovery['idrecovery'], 'AES-128-CBC', pack("a16", User::SECRET), 0, pack("a16", User::SECRET_IV));
